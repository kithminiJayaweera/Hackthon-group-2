        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/policies-&-procedures" className="text-gray-400 hover:text-white">Policies & Procedures</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-gray-400 hover:text-white"><span className="sr-only">Facebook</span> {/* Insert icon */}c</a>
              <a href="#" className="text-gray-400 hover:text-white"><span className="sr-only">LinkedIn</span> {/* Insert icon */}</a>
              <a href="#" className="text-gray-400 hover:text-white"><span className="sr-only">Instagram</span> {/* Insert icon */}</a>
            </div>
          </div>
        </div>
